...
from obsloader_file import ObsFileLoader

from pathlib import Path

FILE_PATH_MD = r'C:\Users\kaust\OneDrive\Documents\Obsidian_RAG\2025.md'

loader = ObsFileLoader(FILE_PATH_MD)
...
CHROMA_DIR = "./chroma_db_custom_loader"
...
# system context bhi hona chahiye --> current date and time --> what are my today's tasks?
